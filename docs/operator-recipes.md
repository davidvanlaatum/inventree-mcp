...
- Current gap: purchase-order creation and retry/recovery reads are available, but receiving remains disabled until the operator approves whether received stock is created, merged, or updated. Parameter template/default administration and some broader live-order-entry recovery surfaces remain tracked separately in F-S11 through F-S15.
