...
- Acceptance:
  ...
  - Update `docs/PLAN.md`, `docs/operator-recipes.md`, README configuration guidance, packaged examples, and relevant auth/config reference docs with the endpoint, client setup, and security model.
...
- Open decisions: none currently. The implementation must still define the exact endpoint paths, request-form precedence when both credentials are supplied, and configuration names while preserving the decisions above.
- Tasks:
