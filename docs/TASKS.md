...
- Acceptance:
  ...
  - Update `docs/PLAN.md`, `docs/operator-recipes.md`, README configuration guidance, packaged examples, and relevant auth/config reference docs with the `/mcp`-prefixed routes, client setup, reverse-proxy rules, and security model.
