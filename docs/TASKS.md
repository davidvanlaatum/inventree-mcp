...
- Acceptance:
  ...
  - Tests cover log level, source-IP field removal, representative ID/search/bulk context, tool and outbound-request completion fields, multi-call correlation, trace correlation, and redaction.
...
- Tasks:
  - [ ] Define the allowlisted per-tool context fields and structured invocation/completion log contract.
  - [ ] Implement INFO invocation/completion logs, outbound InvenTree request completion logs, and trace correlation.
