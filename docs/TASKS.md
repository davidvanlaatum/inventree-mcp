...
- Acceptance:
  ...
  - Tests cover log level, source-IP field removal, representative ID/search/bulk context, completion fields, trace correlation, and redaction.
...
- Tasks:
  ...
  - [ ] Implement INFO invocation/completion logs and trace correlation.
  - [ ] Add focused context, completion, trace, and redaction tests; update documentation.
