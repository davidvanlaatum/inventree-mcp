...
func TestPurchaseOrderDetailsPreserveNullableFieldsAndOmitUnapprovedData(t *testing.T) {
	...
	r.NoError(json.Unmarshal([]byte(`{"pk":10,"reference":"PO-0001","supplier":30,"supplier_reference":"","description":"","status":10,"created_by":{"pk":7,"username":"admin"},"creation_date":null,"issue_date":null,"start_date":null,"target_date":null,"complete_date":null,"line_items":null,"completed_lines":0,"link":"","status_text":"Pending","status_custom_key":null,"notes":null,"overdue":false,"supplier_name":"Acme","total_price":null,"order_currency":null,"destination":null,"updated_at":null,"barcode_hash":"secret","project_code":null,"responsible":null,"contact":null,"address":null,"address_detail":null,"contact_detail":null,"project_code_detail":null,"project_code_label":null,"responsible_detail":null,"parameters":[],"tags":["deferred"],"supplier_detail":{"pk":30}}`), &order))
	...
	assertPurchaseOrderJSONOmits(t, order, "barcode_hash", "project_code", "responsible", "contact", "address", "address_detail", "contact_detail", "project_code_detail", "project_code_label", "responsible_detail", "parameters", "tags", "supplier_detail")
