...
var clientMethodRoutes = map[string]clientRoute{
	...
	"SearchPartTestTemplatesPage":           {Method: "GET", Path: "/api/part/test-template/", Family: RequestFamilyJSONAPI, ManifestID: "search_part_test_templates"},
	"GetPartTestTemplate":                   {Method: "GET", Path: "/api/part/test-template/{id}/", Family: RequestFamilyJSONAPI, ManifestID: "get_part_test_template"},
	"SearchStockItemTestResultsPage":        {Method: "GET", Path: "/api/stock/test/", Family: RequestFamilyJSONAPI, ManifestID: "search_stock_item_test_results"},
	"GetStockItemTestResult":                {Method: "GET", Path: "/api/stock/test/{id}/", Family: RequestFamilyJSONAPI, ManifestID: "get_stock_item_test_result"},
	"DownloadStockItemTestResultAttachment": {Method: "GET", Path: "/media/{path}", Family: RequestFamilyAttachmentDownload, ManifestID: "download_stock_item_test_result_attachment_content"},
