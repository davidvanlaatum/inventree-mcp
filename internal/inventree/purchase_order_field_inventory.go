...
var PurchaseOrderFieldInventory = map[string]PurchaseOrderFieldClass{
	...
	"project_code":        PurchaseOrderFieldDeferred,
	"reference":           PurchaseOrderFieldExposed,
	"responsible":         PurchaseOrderFieldDeferred,
	"contact":             PurchaseOrderFieldDeferred,
	"address":             PurchaseOrderFieldDeferred,
	...
	"address_detail":      PurchaseOrderFieldDeferred,
	"contact_detail":      PurchaseOrderFieldDeferred,
	"project_code_detail": PurchaseOrderFieldDeferred,
	"project_code_label":  PurchaseOrderFieldDeferred,
	"responsible_detail":  PurchaseOrderFieldDeferred,
