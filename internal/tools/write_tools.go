...
func registerWriteTools(server *mcp.Server, deps Dependencies) {
	...
	registerObjectParameterBulkWriteTools(server, deps)
	...
	registerCatalogBulkWriteTools(server, deps)
	...
	registerStockTransferBulkWriteTools(server, deps)
	...
	registerAttachmentBulkWriteTools(server, deps)
	registerRenderAndAttachComponentImageTool(server, deps)
	registerPurchasingWriteTools(server, deps)
	registerPurchasingBulkWriteTools(server, deps)
