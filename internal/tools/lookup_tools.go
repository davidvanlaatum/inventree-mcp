...
const (
	...
	SearchPartTestTemplatesToolName               = "search_part_test_templates"
	GetPartTestTemplateToolName                   = "get_part_test_template"
	SearchStockItemTestResultsToolName            = "search_stock_item_test_results"
	GetStockItemTestResultToolName                = "get_stock_item_test_result"
	DownloadStockItemTestResultAttachmentToolName = "download_stock_item_test_result_attachment"
...
var lookupToolNames = []string{
	...
	SearchPartTestTemplatesToolName,
	GetPartTestTemplateToolName,
